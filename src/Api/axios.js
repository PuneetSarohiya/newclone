...
const requests = {
  ...
  Adventuremovies : `discover/movie?with_genres=${genres.Adventure}`,
  AnimationMovies: `discover/movie?with_genres=${genres.Animation}`,
  DramaMovies: `discover/movie?with_genres=${genres.Drama}`,
  FamilyMovies: `discover/movie?with_genres=${genres.Family}`,
  MusicMovies: `discover/movie?with_genres=${genres.Music}`,
  MysteryMovies: `discover/movie?with_genres=${genres.Mystery}`,
  ThrillerMovies: `discover/movie?with_genres=${genres.Thriller}`,
  WarMovies: `discover/movie?with_genres=${genres.War}`,
  WesternMovies: `discover/movie?with_genres=${genres.Western}`,
};
